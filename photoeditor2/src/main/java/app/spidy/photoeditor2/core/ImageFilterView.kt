...
internal class ImageFilterView : GLSurfaceView, GLSurfaceView.Renderer {
    ...
    fun setSourceBitmap(sourceBitmap: Bitmap?) { /* if (mSourceBitmap != null && mSourceBitmap.sameAs(sourceBitmap)) {
            //mCurrentEffect = NONE;
        }*/
    ...
    override fun onDrawFrame(gl: GL10) {
        if (!mInitialized) { //Only need to do this once
